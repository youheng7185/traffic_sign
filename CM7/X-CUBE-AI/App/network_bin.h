/**
  ...
  ******************************************************************************
  */
#ifndef AI_NETWORK_BIN_H
#define AI_NETWORK_BIN_H

#include "network_bin_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_BIN_MODEL_NAME          "network_bin"
#define AI_NETWORK_BIN_ORIGIN_MODEL_NAME   "binary_classifier_int8"

/******************************************************************************/
#define AI_NETWORK_BIN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_BIN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_BIN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_BIN_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_BIN_IN \
  ai_network_bin_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_BIN_IN_SIZE { \
  AI_NETWORK_BIN_IN_1_SIZE, \
}
#define AI_NETWORK_BIN_IN_SIZE_BYTES { \
  AI_NETWORK_BIN_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_BIN_IN_1_FORMAT      (AI_BUFFER_FORMAT_U8)
#define AI_NETWORK_BIN_IN_1_HEIGHT      (32)
#define AI_NETWORK_BIN_IN_1_WIDTH       (32)
#define AI_NETWORK_BIN_IN_1_CHANNEL     (3)
#define AI_NETWORK_BIN_IN_1_SIZE        (3072)
#define AI_NETWORK_BIN_IN_1_SIZE_BYTES  (3072)

/******************************************************************************/
#define AI_NETWORK_BIN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_BIN_OUT \
  ai_network_bin_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_BIN_OUT_SIZE { \
  AI_NETWORK_BIN_OUT_1_SIZE, \
}
#define AI_NETWORK_BIN_OUT_SIZE_BYTES { \
  AI_NETWORK_BIN_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_BIN_OUT_1_FORMAT      (AI_BUFFER_FORMAT_U8)
#define AI_NETWORK_BIN_OUT_1_CHANNEL     (2)
#define AI_NETWORK_BIN_OUT_1_SIZE        (2)
#define AI_NETWORK_BIN_OUT_1_SIZE_BYTES  (2)

/******************************************************************************/
#define AI_NETWORK_BIN_N_NODES (7)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_bin
 ...
 * @ref ai_network_bin_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_bin_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_bin_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_bin_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_BIN_*
 * defines into file @ref network_bin.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_bin_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_BIN_H */
